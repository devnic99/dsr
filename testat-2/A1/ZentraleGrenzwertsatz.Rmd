...
plots = list()
for (i in 1:6) {
    plots[[i]] = ggplot(g) + geom_histogram(aes(x = g[,i]), binwidth = 0.25, alpha=alpha) + xlim(-5, 5) +
...
p1 = ggplot(g) + geom_histogram(aes(x = G_1), binwidth = 0.25, alpha=alpha) + xlim(-5, 5)+ 
   geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
p2 = ggplot(g) + geom_histogram(aes(x = G_2), binwidth = 0.25, alpha=alpha) + xlim(-5, 5) +
   geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
p3 = ggplot(g) + geom_histogram(aes(x = G_3), binwidth = 0.25, alpha=alpha) + xlim(-5, 5) +
    geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
p4 = ggplot(g) + geom_histogram(aes(x = G_10), binwidth = 0.2, alpha=alpha) + xlim(-5, 5) +
    geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
p5 = ggplot(g) + geom_histogram(aes(x = G_100), binwidth = 0.25, alpha=alpha) + xlim(-5, 5) +
    geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
p6 = ggplot(g) + geom_histogram(aes(x = G_1000), binwidth = 0.25, alpha=alpha) + xlim(-5, 5) +
    geom_histogram(data = normal_dist, aes(x = normal), binwidth=0.25, color = "red")
