...
# Ihre Lösung:
ggplot(data) +
  geom_boxplot(aes(x = sex, y = chol, group = sex, color=sex)) +
  labs(title = "Cholesterin in Abhängigkeit des Geschlechts", x = "Geschlecht", y = "Cholesterin")
```
...
# Ihre Lösung:
ggplot(data) +
  geom_boxplot(aes(x = goal, y = chol, group = goal, color=goal)) +
  labs(title = "Cholesterin in Abhängigkeit der Diagnose", x = "Diagnose", y = "Cholesterin")
```
